...
namespace Bonkers.BlokControl
{
    ...
    {
        [SerializeField] private List<GameObject> spawnableBloks;
        ...
        public IEnumerator SpawnRandomBlok()
        {
            ...
            {
                if (blok.TryGetComponent<BlokControl>(out BlokControl blokControl))
                {
