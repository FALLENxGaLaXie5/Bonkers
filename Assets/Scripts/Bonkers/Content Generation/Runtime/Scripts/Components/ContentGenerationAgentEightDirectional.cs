...
{
    public class ContentGenerationAgentEightDirectional : ContentGenerationAgent
    {
        protected List<Vector2Int> adjacentDirections = new List<Vector2Int>
        {
            Vector2Int.up, Vector2Int.left, Vector2Int.right, Vector2Int.down, Vector2Int.up + Vector2Int.left, Vector2Int.up + Vector2Int.right,
        ...
        public override void OnActionReceived(ActionBuffers actions)
        {
            ...
            {
                case 0:
                    blockMappingPosition = ContentGenerationAgentUtility.CalculateBlokMappingPositionEightDirectional(directionToSpawnIn, lastBlokMappingChain1, adjacentDirections);
                    break;
                case 1:
                    blockMappingPosition = ContentGenerationAgentUtility.CalculateBlokMappingPositionEightDirectional(directionToSpawnIn, lastBlokMappingChain2, adjacentDirections);
                    break;
                case 2:
                    blockMappingPosition = ContentGenerationAgentUtility.CalculateBlokMappingPositionEightDirectional(directionToSpawnIn, lastBlokMappingChain3, adjacentDirections);
                    break;
                case 3:
                    blockMappingPosition = ContentGenerationAgentUtility.CalculateBlokMappingPositionEightDirectional(directionToSpawnIn, lastBlokMappingChain4, adjacentDirections);
                    break;
            }
        ...
        protected override void CalculateNewAdjacentPositionsAvailability(BlokMapping blokMapping, int blockChain)
        {
            switch (blockChain)
            {
                case 0:
                    ...
                    Vector2Int topLeftPosition = blokMapping.Value + Vector2Int.up + Vector2Int.left;
                    bool topLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain1.Add(adjacentDirections[4], topLeftPositionTaken);

                    Vector2Int topRightPosition = blokMapping.Value + Vector2Int.up + Vector2Int.right;
                    bool topRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain1.Add(adjacentDirections[5], topRightPositionTaken);

                    Vector2Int bottomLeftPosition = blokMapping.Value + Vector2Int.down + Vector2Int.left;
                    bool bottomLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain1.Add(adjacentDirections[6], bottomLeftPositionTaken);

                    Vector2Int bottomRightPosition = blokMapping.Value + Vector2Int.down + Vector2Int.right;
                    bool bottomRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain1.Add(adjacentDirections[7], bottomRightPositionTaken);
                    break;
                case 1:
                    ...
                    topLeftPosition = blokMapping.Value + Vector2Int.up + Vector2Int.left;
                    topLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain2.Add(adjacentDirections[4], topLeftPositionTaken);

                    topRightPosition = blokMapping.Value + Vector2Int.up + Vector2Int.right;
                    topRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain2.Add(adjacentDirections[5], topRightPositionTaken);

                    bottomLeftPosition = blokMapping.Value + Vector2Int.down + Vector2Int.left;
                    bottomLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain2.Add(adjacentDirections[6], bottomLeftPositionTaken);

                    bottomRightPosition = blokMapping.Value + Vector2Int.down + Vector2Int.right;
                    bottomRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain2.Add(adjacentDirections[7], bottomRightPositionTaken);
                    break;
                case 2:
                    upPosition = blokMapping.Value + Vector2Int.up;
                    upPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(upPosition);
                    ...
                    topLeftPosition = blokMapping.Value + Vector2Int.up + Vector2Int.left;
                    topLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain3.Add(adjacentDirections[4], topLeftPositionTaken);

                    topRightPosition = blokMapping.Value + Vector2Int.up + Vector2Int.right;
                    topRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain3.Add(adjacentDirections[5], topRightPositionTaken);

                    bottomLeftPosition = blokMapping.Value + Vector2Int.down + Vector2Int.left;
                    bottomLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain3.Add(adjacentDirections[6], bottomLeftPositionTaken);

                    bottomRightPosition = blokMapping.Value + Vector2Int.down + Vector2Int.right;
                    bottomRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain3.Add(adjacentDirections[7], bottomRightPositionTaken);
                    break;
                case 3:
                    upPosition = blokMapping.Value + Vector2Int.up;
                    upPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(upPosition);
                    ...
                    topLeftPosition = blokMapping.Value + Vector2Int.up + Vector2Int.left;
                    topLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain4.Add(adjacentDirections[4], topLeftPositionTaken);

                    topRightPosition = blokMapping.Value + Vector2Int.up + Vector2Int.right;
                    topRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(topRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain4.Add(adjacentDirections[5], topRightPositionTaken);

                    bottomLeftPosition = blokMapping.Value + Vector2Int.down + Vector2Int.left;
                    bottomLeftPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomLeftPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain4.Add(adjacentDirections[6], bottomLeftPositionTaken);

                    bottomRightPosition = blokMapping.Value + Vector2Int.down + Vector2Int.right;
                    bottomRightPositionTaken = !contentLevelMapping.CheckIfPositionIsAlreadyTaken(bottomRightPosition);
                    lastBlokMappingAdjacentPositionsAvailableChain4.Add(adjacentDirections[7], bottomRightPositionTaken);
                    break;
            }
        }
    }
